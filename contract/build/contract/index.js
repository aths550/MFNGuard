...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      test: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`test: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('test',
                                     ...
                                     'test_loop.compact line 14 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(class_id_0).concat(_descriptor_0.toValue(c_0)),
        ...
        const result_0 = this._test_0(context, partialProofData, class_id_0, c_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { test: this.circuits.test };
    this.provableCircuits = { test: this.circuits.test };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _test_0(context, partialProofData, class_id_0, c_0) {
    const cls_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 0 } },
                                                                             { idx: { cached: false,
    ...
    const next_slots_0 = [c_0, c_0, c_0, c_0, c_0];
    const next_class_0 = { slots: next_slots_0,
                           filled: cls_0.filled,
                           buyer_ref: cls_0.buyer_ref,
                           buyer_filled: cls_0.buyer_filled };
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'test_loop.compact line 12 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
